...
\begin{tabular}{rl}
    ...
    Projects & \textit{BSc thesis} - \footnotesize{Deep neural networks for emotion recognition} \\
             & \textit{Developing apps in C\#} - \footnotesize{Chat client and server communicating over SignalR.} \\
